...
export default function App() {
  ...
  if (vista === 'propiedades') return <Propiedades onBack={() => setVista('home')} />;
  if (vista === 'visitas')     return <Visitas     onBack={() => setVista('home')} />;
  if (vista === 'inquilinos')  return <Inquilinos  onBack={() => setVista('home')} />;

  return (
    <div className="min-h-screen bg-[#070707] flex flex-col items-center justify-center relative overflow-hidden font-sans">
